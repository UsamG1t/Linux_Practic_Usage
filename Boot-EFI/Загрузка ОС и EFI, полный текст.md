...
# Быстрый поиск
 ...
 + [Задача загрузки](#задача-загрузки)
 + [BIOS и MBR](#bios-и-mbr)
 + [UEFI как современная модель загрузки](#uefi-как-современная-модель-загрузки)
   + [GUID Partition Table](#guid-partition-table)
     + [Структура GPT на диске](#структура-gpt-на-диске)
   + [EFI System Partition](#efi-system-partition)
 + [Многофункциональный загрузчик GRUB](#многофункциональный-загрузчик-grub)
   + [Возможность обойтись без GRUB](#возможность-обойтись-без-grub)
