...
$$\textrm{if\ \textbf{команды};\ then\ \textbf{команды-True};\ else\ \textbf{команды-False};\ fi}$$
 ...
 + Цикл
	 + Цикл с условием: $$\textrm{while\ \textbf{команды};\ do\ \textbf{команды};\ done}$$
	 + Цикл по последовательности: $$\textrm{for\ \textbf{переменная}\ in\ \textbf{слова};\ do\ \textbf{команды};\ done}$$
